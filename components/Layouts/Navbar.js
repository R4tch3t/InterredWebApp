                    ...
                    <nav className="navbar navbar-expand-md navbar-light">
                        <div className="container">
                            <Link href="/">
                                ...
                                <div style={{position: 'relative',borderRadius: 70, backgroundColor: 'black'}} >
                                    <video width="250" height="100" autoPlay loop muted color='transparent'>
                                ...
                                <ul className="navbar-nav m-auto">
                                    <li className="nav-item">
                                        ...
                                        <ul className="dropdown-menu">
                                            ...
                                            <li className="nav-item">
                                                <Link href="/steps" activeClassName="active">
