                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            ...
                            <div className="single-business">
                                ...
                                <p>Investigation in the area of AI and Cybersecurity.</p>
                            </div>

                            <div className="single-business">
                                <i className="flaticon-blockchain"></i>
                                <h3>A Community With A Unique Mission</h3>
                                <p>Adonay Industries presents a Unique Mission for the World and the people, it's the advance of human technology for resolve any problem.</p>
                            </div>
